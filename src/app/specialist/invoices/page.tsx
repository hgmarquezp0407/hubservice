...
import { formatDateTime12Hour } from "@/utils/validators";
                ...
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Mis Facturas Recibidas</div>
                                            ...
                                            <tr key={invoice.id}>
                                                ...
                                                <td>
                                                    <span className="text-danger fw-medium">
                                                        -${invoice.platform_fee_usd.toLocaleString("en-US", { minimumFractionDigits: 2 })}
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="fw-medium text-success">
                                                        ${invoice.specialist_cost_usd.toLocaleString("en-US", { minimumFractionDigits: 2 })}
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-1">
                                                        <Link href={`/specialist/invoices/detail?id=${invoice.id}`} className="btn btn-info-light btn-sm" title="Ver detalle">
