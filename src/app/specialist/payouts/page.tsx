...
export default function Payouts() {
    ...
    return (
        <Fragment>
            <Seo title="Mis Pagos Recibidos" />

            <Row>
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Mis Pagos Recibidos</div>
                            ...
                            <div className="table-responsive">
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <tr><td colSpan={10} className="text-center py-4">Ningún pago recibido aún.</td></tr>
                                    ) : (
                                            ...
                                            <tr key={payout.id}>
                                                ...
                                                <td>
                                                    <span className="fw-medium">
                                                        ${payout.gross_amount.toLocaleString("en-US", { minimumFractionDigits: 2 })}
                                                    </span>
                                                </td>
                                                <td>
                                                    <span className="text-danger">
                                                        -${payout.platform_fee.toLocaleString("en-US", { minimumFractionDigits: 2 })}
                                                    </span>
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <span className="fw-medium text-success">
                                                        ${(payout.net_after_retention ?? payout.net_amount).toLocaleString("en-US", { minimumFractionDigits: 2 })} {payout.currency_id}
                                                    </span>
                                                </td>
                                                ...
                                                <td>{payout.scheduled_at ? formatDate(payout.scheduled_at) : <span className="text-muted">—</span>}</td>
