...
export default function Contracts() {
    ...
    const handleComplete = async (id: string) => {
        const result = await Swal.fire({
            ...
            text              : "Se generará la orden automáticamente para revisión de la empresa.",
            icon              : "question",
        ...
        try {
            ...
            await Swal.fire("¡Completado!", data.message || "Contrato completado. La orden fue generada.", "success")
            fetchItems(currentPage, search)
        } catch (err: any) {
    ...
    return (
        <Fragment>
            <Seo title="Mis Contratos" />

            <Row>
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Mis Contratos</div>
                                            ...
                                            <tr key={contract.id}>
                                                ...
                                                <td>
                                                    <span className="fw-medium">
                                                        ${contract.agreed_price_usd.toLocaleString("en-US", { minimumFractionDigits: 2 })}
                                                    </span>
                                                </td>
                                                <td>
                                                    ...
                                                    <div className="d-flex align-items-center gap-1">
                                                        ...
                                                        {contract.contract_status_id === "active" && (
                                                            <SpkButton
                                                                ...
                                                                onClickfunc={() => handleComplete(contract.id)}
                                                            >
