...
import PaymentModal from "@/app/components/orders/PaymentModal";
...
export default function Orders() {
    ...
    const [orderToPay, setOrderToPay]   = useState<IOrders | null>(null)
    ...
    const handleConfirm = async (id: string) => {
        const result = await Swal.fire({
            ...
            text              : "Se aprobará la orden y quedará lista para pago.",
            icon              : "question",
    ...
    return (
        <Fragment>
            <Seo title="Mis Órdenes" />

            <Row>
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Mis Órdenes</div>
                                            ...
                                            <tr key={order.id}>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-1">
                                                        ...
                                                        {order.order_status_id === "approved" && (
                                                            <SpkButton Buttonvariant="primary" Size="sm" Buttontoggle="tooltip" Title="Pagar con Stripe" onClickfunc={() => handlePay(order)}>
