...
import { IConfig, IInvoices } from "@/app/interfaces/general_interface";
                ...
                <Col xl={3}>
                    <Card className="custom-card">
                        <div className="card-header">
                            <div className="card-title">Estado del comprobante</div>
                        ...
                        <Card.Body>
                            <div className="row gy-3">
                                ...
                                <Col xl={12}>
                                    <p className="fw-medium text-muted fs-12 mb-1">Total a pagar:</p>
