...
export default function Bids() {
    ...
    const handleAccept = async (id: string) => {
        setAccepting(id)
        try {
            await apiFetch(`${urlbase}/admin/bids/${id}/accept`, { method: "POST" })
            toast.success("Propuesta aceptada. El contrato será creado en breve.")
            fetchItems(currentPage, search)
        } catch (err: any) {
                ...
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Propuestas recibidas</div>
                            ...
                            <div className="table-responsive">
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <tr><td colSpan={9} className="text-center py-4">Ninguna propuesta recibida.</td></tr>
                                    ) : (
                                        items.map((bid, index) => (
                                            <tr key={bid.id}>
                                                    ...
                                                    <div className="d-flex align-items-center gap-1">
                                                        ...
                                                        {bid.bid_status_id === "pending" && (
                                                            <SpkButton
                                                                ...
                                                                onClickfunc={() => handleAccept(bid.id)}
                                                            >
                                                                {accepting === bid.id
