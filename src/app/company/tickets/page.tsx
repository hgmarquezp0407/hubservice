...
const CANCELLABLE = ["open", "assigned", "in_progress", "pending_review"]
const EDITABLE    = ["open", "assigned", "in_progress", "pending_review"]
...
export default function Tickets() {
    ...
    const handleCancel = async (id: string) => {
        ...
        setCancelling(id)
        try {
            await apiFetch(`${urlbase}/admin/tickets/${id}/cancel`, { method: "POST" })
                    ...
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            ...
                            <div className="d-flex flex-wrap gap-2">
                                ...
                                <SpkButton Buttonvariant="primary" Size="sm" Customclass="waves-light" onClickfunc={() => setShowCreate(true)}>
                                    <i className="ri-add-line fw-medium align-middle me-1"></i> Nuevo ticket
                                </SpkButton>
                            </div>
                        </Card.Header>
                        ...
                        <Card.Body>
                            <div className="table-responsive">
                                ...
                                >
                                    {loading ? (
                                        <tr><td colSpan={11} className="text-center py-4"><i className="ri-loader-2-fill fs-20 me-2" /> Cargando...</td></tr>
                                    ) : items.length === 0 ? (
                                        <tr><td colSpan={11} className="text-center py-4">Ningún dato para mostrar.</td></tr>
                                    ) : (
                                            ...
                                            <tr key={ticket.id}>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-1">
                                                        ...
                                                        {EDITABLE.includes(ticket.ticket_status_id) && (
                                                            <SpkButton Buttonvariant="primary-light" Size="sm" Buttontoggle="tooltip" Title="Editar" onClickfunc={() => handleEdit(ticket.id)}>
                                                                <i className="ri-edit-line"></i>
                                                            </SpkButton>
                                                        )}
                                                        {CANCELLABLE.includes(ticket.ticket_status_id) && (
                                                            <SpkButton
                                                                ...
                                                                onClickfunc={() => handleCancel(ticket.id)}
                                                            >
