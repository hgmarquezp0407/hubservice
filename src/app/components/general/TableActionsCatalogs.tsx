...
//     stateId: number
//     permissions: string[]
//     /** Si true, oculta el botón Eliminar (ej: registro protegido con id=1) */
//     protected?: boolean
...
// export default function TableActionsCatalogs({ id, stateId, permissions, protected: isProtected = false, onView, onEdit, onDelete, onRestore }: TableActionsProps) {
//     const isInactive = stateId === 0

//     return (
//         <div className="d-flex align-items-center gap-1">
//             {can(permissions, "VIEW") && onView && (
//                 <SpkButton Buttonvariant="info-light" Size="sm" Customclass="btn-icon" Buttontoggle="tooltip" data-bs-placement="top" Title="Ver detalle" onClickfunc={() => onView(id)} >
//                     <i className="ri-eye-line"></i>
//                 </SpkButton>
//             )}
//             {isInactive ? (
//                 // Registro inactivo: solo mostrar Restaurar
//                 <>
//                     {
//                         can(permissions, "RESTORE") && onRestore && (
//                             <SpkButton Buttonvariant="success-light" Size="sm" Customclass="btn-icon" Buttontoggle="tooltip" data-bs-placement="top" Title="Restaurar" onClickfunc={() => onRestore(id)}>
...
//                 </>
//             ) : (
//                 // Registro activo: Editar y/o Eliminar 
//                 <>
//                     {
//                         can(permissions, "EDIT") && onEdit && (
//                             <SpkButton Buttonvariant="primary-light" Size="sm" Buttontoggle="tooltip" data-bs-placement="top" Title="Editar" onClickfunc={() => onEdit(id)}>
...
//                     {
//                         can(permissions, "DELETE") && !isProtected && onDelete && (
//                             <SpkButton Buttonvariant="danger-light" Size="sm" Customclass="btn-icon" Buttontoggle="tooltip" data-bs-placement="top" Title="Eliminar" onClickfunc={() => onDelete(id)}>
...
export default function TableActionsCatalogs({ id, stateId, permissions, protected: isProtected = false, ...handlers }: TableActionsProps) {
    const isInactive = stateId === 0
