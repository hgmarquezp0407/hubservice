                ...
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Gestión de Propuestas</div>
                                    ...
                                    {loading ? (
                                        ...
                                        items.map((bid, index) => (
                                            <tr key={bid.id}>
                                                ...
                                                <td>
                                                    <div style={{ maxWidth: 180 }} className="text-truncate" title={bid.ticket?.title}>
                                                        <span className="fw-medium text-primary">{bid.ticket?.ticket_number ?? "—"}</span>
                                                        <span className="text-muted ms-1 fs-12">{bid.ticket?.title ?? ""}</span>
                                                    </div>
                                                </td>
                                                <td>
                                                    {bid.specialist
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-1">
                                                        ...
                                                        <SpkButton Buttonvariant="danger-light" Size="sm" Customclass="btn-icon" Buttontoggle="tooltip" Title="Eliminar" onClickfunc={() => handleDelete(bid.id)}>
