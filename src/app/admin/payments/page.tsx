...
export default function Payments() {
    ...
    return (
        <Fragment>
                ...
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Gestión de Pagos</div>
                            <div className="d-flex flex-wrap gap-2">
                                <div className="custom-form-group flex-grow-1">
                                    <input className="form-control form-control-sm" type="text" placeholder="Buscar pago..." value={search} onChange={handleSearchChange} />
                                            ...
                                            <tr key={payment.id}>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-1">
                                                        ...
                                                        <SpkButton Buttonvariant="danger-light" Size="sm" Customclass="btn-icon" Buttontoggle="tooltip" Title="Eliminar" onClickfunc={() => handleDelete(payment.id)}>
            ...
            <ViewPaymentModal show={showView} onHide={() => setShowView(false)} payment={paymentToView} />
        </Fragment>
    )
}