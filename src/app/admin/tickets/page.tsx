                ...
                <Col xxl={12}>
                    <Card className="custom-card">
                        <Card.Header className="card-header justify-content-between">
                            <div className="card-title">Gestión de Tickets</div>
                                            ...
                                            <tr key={ticket.id}>
                                                ...
                                                <td>
                                                    <div className="d-flex align-items-center gap-1">
                                                        ...
                                                        <SpkButton Buttonvariant="danger-light" Size="sm" Customclass="btn-icon" Buttontoggle="tooltip" Title="Eliminar" onClickfunc={() => handleDelete(ticket.id)}>
