...
import {ZoomableGroup, ComposableMap, Geographies, Geography, Graticule, Annotation, Marker} from "react-simple-maps";
...
export const WorldMap = ({ setTooltipContent, dataThemeMode }: any) => {
	return (
		<>
...
const connectorProps: SVGProps<SVGPathElement> = {
